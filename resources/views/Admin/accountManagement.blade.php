    ...
    <div class="quick-stats">
        ...
        <div class="stats-grid">
            <div class="quick-stat-item">
                <div class="quick-stat-number">{{ App\Models\Student::count() }}</div>
                <div class="quick-stat-label">Tổng học sinh</div>
            </div>
            <div class="quick-stat-item">
                <div class="quick-stat-number">{{ App\Models\Teacher::count() }}</div>
                <div class="quick-stat-label">Tổng giáo viên</div>
            </div>
            <div class="quick-stat-item">
                <div class="quick-stat-number">{{ App\Models\Login::count() }}</div>
                <div class="quick-stat-label">Tổng tài khoản</div>
            </div>
            <div class="quick-stat-item">
                <div class="quick-stat-number">{{ App\Models\Login::where('is_active', true)->count() }}</div>
    ...
    <div class="management-grid">
        ...
        <div class="management-card">
            ...
            <div class="stats-row">
                ...
                <div class="stat-item">
                    <div class="stat-number">{{ App\Models\Student::whereNotNull('login_id')->count() }}</div>
                    <div class="stat-label">Có tài khoản</div>
                </div>
                <div class="stat-item">
                    <div class="stat-number">{{ App\Models\Student::whereNull('login_id')->count() }}</div>
                    <div class="stat-label">Chưa có TK</div>
                </div>
            </div>
            
            <div class="card-actions">
                <a href="{{ route('admin.student-accounts.index') }}" class="btn btn-primary">
        ...
        <div class="management-card">
            ...
            <div class="stats-row">
                ...
                <div class="stat-item">
                    <div class="stat-number">{{ App\Models\Teacher::whereNotNull('login_id')->count() }}</div>
                    <div class="stat-label">Có tài khoản</div>
                </div>
                <div class="stat-item">
                    <div class="stat-number">{{ App\Models\Teacher::whereNull('login_id')->count() }}</div>
                    <div class="stat-label">Chưa có TK</div>
                </div>
            </div>
            ...
            <div class="card-actions">
                ...
                <a href="{{ route('admin.teacher-accounts.create') }}" class="btn btn-secondary">
                    <i class="fas fa-plus"></i>
                    Thêm mới
                </a>
            </div>
