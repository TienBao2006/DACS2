...
<div class="document-create">
    <div class="page-header">
        <h1><i class="fas fa-plus"></i> Thêm tài liệu mới</h1>
    ...
    <div class="form-container">
        <form action="{{ route('admin.documents.store') }}" method="POST" enctype="multipart/form-data" class="document-form">
            @csrf
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-textarea" rows="4" 
                                  placeholder="Mô tả ngắn về tài liệu">{{ old('description') }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="tags" name="tags" class="form-input" 
                               value="{{ old('tags') }}" placeholder="Nhập từ khóa, cách nhau bằng dấu phẩy">
            ...
            <div class="form-section">
                <h3><i class="fas fa-upload"></i> Tải lên tài liệu</h3>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleFileSelect(file) {
        ...
        document.querySelector('.file-icon').className = 'file-icon ' + fileIcon;
