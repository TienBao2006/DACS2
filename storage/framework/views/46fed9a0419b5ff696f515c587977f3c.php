...
<body class="bg-background-light dark:bg-background-dark font-display text-text-main dark:text-gray-100 flex flex-col min-h-screen overflow-x-hidden">
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-4 lg:gap-8">
                    ...
                    <nav class="hidden lg:flex items-center gap-6 xl:gap-9">
                        <a class="text-sm font-medium text-primary" href="<?php echo e(route('homepage')); ?>">Trang chủ</a>
                                        <a class="text-sm font-medium text-primary" href="<?php echo e(route('homepage.news')); ?>">Tin tức</a>
                        <a class="text-sm font-medium hover:text-primary transition-colors" href="<?php echo e(route('homepage.teachers')); ?>">Giáo viên</a>
                        <a class="text-sm font-medium hover:text-primary transition-colors" href="<?php echo e(route('homepage.documents')); ?>">Tài liệu</a>
                ...
                <div class="flex items-center gap-4">
                    <!-- Search Bar (Desktop) -->
                    <form action="<?php echo e(route('homepage.search')); ?>" method="GET" class="hidden md:flex flex-col min-w-40 h-10 w-64 relative group">
                    ...
                    <!-- Login Button -->
                    <a href="<?php echo e(route('login.form')); ?>" class="flex items-center justify-center h-10 px-5 rounded-lg bg-primary hover:bg-primary-dark text-white text-sm font-bold transition-colors shadow-sm">
                        <span>Đăng nhập</span>
                    </a>
                    <!-- Mobile Menu Button -->
    ...
    <?php if($banners->count() > 0): ?>
        <?php $__currentLoopData = $banners->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <section class="relative w-full bg-surface-light dark:bg-surface-dark">
            <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10 py-5 lg:py-8">
                <div class="relative w-full rounded-2xl overflow-hidden min-h-[480px] flex flex-col items-center justify-center p-8 text-center bg-cover bg-center shadow-md group" 
                     style="background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.6)), url('<?php echo e($banner->image_url); ?>');">
                    <div class="flex flex-col gap-4 max-w-3xl z-10 animate-fade-in-up">
                        <h1 class="text-white text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-tight drop-shadow-sm">
                            <?php echo e($banner->title ?? 'Chào mừng đến với Trường THPT Bách Khoa Lịch Sử'); ?>

                        </h1>
                        <h2 class="text-gray-100 text-base md:text-lg font-medium leading-relaxed max-w-2xl mx-auto drop-shadow-sm">
                            <?php echo e($banner->description ?? 'Nơi ươm mầm tài năng, rèn luyện nhân cách và kiến tạo tương lai vững chắc cho thế hệ trẻ.'); ?>

                        </h2>
                    </div>
                    <div class="flex flex-wrap gap-4 mt-8 z-10 justify-center">
                        <?php if($banner->button_text && $banner->button_url): ?>
                        <a href="<?php echo e(route('homepage.news')); ?>" class="flex items-center justify-center h-12 px-8 rounded-lg bg-primary hover:bg-primary-dark text-white text-base font-bold shadow-lg transition-transform hover:-translate-y-0.5">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(route('login.form')); ?>" class="flex items-center justify-center h-12 px-8 rounded-lg bg-white/90 hover:bg-white text-text-main text-base font-bold backdrop-blur-sm transition-colors">
    ...
    <section class="py-8 bg-surface-light dark:bg-surface-dark border-b border-gray-100 dark:border-gray-800">
        <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <a class="flex flex-col p-5 rounded-xl border border-[#dce0e5] dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-primary hover:shadow-md transition-all group" href="<?php echo e(route('login.form')); ?>">
                ...
                <!-- Card 3: Thư viện số -->
                <a class="flex flex-col p-5 rounded-xl border border-[#dce0e5] dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-primary hover:shadow-md transition-all group" href="<?php echo e(route('homepage.documents')); ?>">
                    <div class="mb-4 text-primary group-hover:scale-110 transition-transform origin-left">
                ...
                <!-- Card 4: Liên hệ GVCN -->
                <a class="flex flex-col p-5 rounded-xl border border-[#dce0e5] dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-primary hover:shadow-md transition-all group" href="<?php echo e(route('homepage.teachers')); ?>">
                    <div class="mb-4 text-primary group-hover:scale-110 transition-transform origin-left">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-8 flex flex-col gap-6">
                    <div class="flex items-center justify-between">
                        ...
                        <a class="text-primary hover:text-primary-dark font-medium text-sm flex items-center gap-1" href="<?php echo e(route('homepage.news')); ?>">
                    ...
                    <?php $firstNews = $featuredNews->first(); ?>
                    <div class="group relative flex flex-col md:flex-row gap-0 md:gap-6 bg-white dark:bg-gray-800 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all">
                        <div class="w-full md:w-2/5 h-48 md:h-auto overflow-hidden">
                            <div class="w-full h-full bg-cover bg-center transition-transform duration-500 group-hover:scale-105" 
                                 style="background-image: url('<?php echo e($firstNews->image_url); ?>');"></div>
                        </div>
                        <div class="flex flex-col justify-center p-6 flex-1">
                            <div class="flex items-center gap-2 mb-3">
                                <span class="bg-primary/10 text-primary text-xs font-bold px-2 py-1 rounded"><?php echo e($firstNews->category ?? 'Hoạt động'); ?></span>
                                <span class="text-text-muted dark:text-gray-400 text-xs flex items-center gap-1">
                                    <span class="material-symbols-outlined text-xs">schedule</span> <?php echo e($firstNews->created_at->format('d/m/Y')); ?>

                                </span>
                            </div>
                            <h3 class="text-xl font-bold text-text-main dark:text-white mb-2 group-hover:text-primary transition-colors">
                                <a href="<?php echo e(route('homepage.news.detail', $firstNews->id)); ?>"><?php echo e($firstNews->title); ?></a>
                            </h3>
                            <p class="text-text-muted dark:text-gray-400 text-sm line-clamp-2 mb-4">
                                <?php echo e(Str::limit($firstNews->summary ?? $firstNews->content, 150)); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <?php if($latestNews->count() >= 2): ?>
                            <?php $__currentLoopData = $latestNews->skip(1)->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="bg-white dark:bg-gray-800 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all group h-full flex flex-col">
                                <div class="h-48 overflow-hidden relative">
                                    <div class="w-full h-full bg-cover bg-center transition-transform duration-500 group-hover:scale-105" 
                                         style="background-image: url('<?php echo e($news->image_url); ?>');"></div>
                                </div>
                                <div class="p-5 flex flex-col flex-1">
                                    <div class="text-xs text-text-muted dark:text-gray-400 mb-2"><?php echo e($news->created_at->format('d/m/Y')); ?></div>
                                    <h3 class="text-lg font-bold text-text-main dark:text-white mb-2 line-clamp-2 group-hover:text-primary transition-colors">
                                        <a href="<?php echo e(route('homepage.news.detail', $news->id)); ?>"><?php echo e($news->title); ?></a>
                                    </h3>
                                    <p class="text-sm text-text-muted dark:text-gray-400 line-clamp-3 mb-4 flex-1">
                                        <?php echo e(Str::limit($news->summary ?? $news->content, 120)); ?>
                ...
                <div class="lg:col-span-4 flex flex-col gap-6">
                    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden h-full">
                        ...
                        <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 flex items-center justify-between">
                            ...
                            <a class="text-xs font-semibold text-primary hover:underline" href="<?php echo e(route('homepage.notifications')); ?>">Xem tất cả</a>
                        </div>
                        <!-- List Items -->
                        <div class="divide-y divide-gray-100 dark:divide-gray-700">
                            <?php if($notifications->count() > 0): ?>
                                <?php $__currentLoopData = $notifications->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="p-5 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group cursor-pointer">
                                    <div class="flex items-start gap-3">
                                        <?php if($index === 0 && $notification->priority === 'urgent'): ?>
                                        <div class="flex flex-col items-center min-w-[50px] bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-lg p-1.5 border border-red-200 dark:border-red-800">
                                            <span class="text-xs font-bold uppercase"><?php echo e($notification->created_at->format('M')); ?></span>
                                            <span class="text-lg font-bold leading-none"><?php echo e($notification->created_at->format('d')); ?></span>
                                        </div>
                                        <?php elseif($index === 0): ?>
                                        ...
                                        <div class="flex flex-col gap-1 flex-1">
                                            ...
                                            <p class="text-xs text-text-muted dark:text-gray-400">
                                                ...
                                                ?>
                                                <?php echo e($department); ?> • <?php echo e($notification->created_at->diffForHumans()); ?>

                                            </p>
                                            <?php if($notification->content && strlen($notification->content) > 0): ?>
                                            <p class="text-xs text-text-muted dark:text-gray-500 mt-1 line-clamp-2">
                                                <?php echo e(Str::limit($notification->content, 100)); ?>
                        ...
                        <div class="p-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-700">
                            <a href="<?php echo e(route('homepage.notifications')); ?>" class="w-full flex items-center justify-center gap-2 text-sm font-medium text-text-muted hover:text-primary transition-colors py-2">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="text-center">
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all">
                        ...
                        <div class="text-4xl font-bold text-white mb-2"><?php echo e(number_format($statistics['total_students'])); ?></div>
                ...
                <div class="text-center">
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all">
                        ...
                        <div class="text-4xl font-bold text-white mb-2"><?php echo e(number_format($statistics['total_teachers'])); ?></div>
                ...
                <div class="text-center">
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all">
                        ...
                        <div class="text-4xl font-bold text-white mb-2"><?php echo e(number_format($statistics['total_news'])); ?></div>
                ...
                <div class="text-center">
                    <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all">
                        ...
                        <div class="text-4xl font-bold text-white mb-2"><?php echo e(number_format($statistics['total_documents'])); ?></div>
    ...
    <footer class="bg-background-dark text-white pt-12 pb-8 border-t border-gray-800">
        <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10">
            ...
            <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-xs text-gray-500">© <?php echo e(date('Y')); ?> Trường THPT Chuyên. All rights reserved.</p>
...
</html><?php /**PATH F:\Xampp\htdocs\laravel\Myto\resources\views/homepage/index.blade.php ENDPATH**/ ?>