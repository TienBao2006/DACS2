        ...
        <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10">
            <div class="text-center">
                ...
                <nav class="flex items-center justify-center gap-2 text-white/80">
                    <a href="<?php echo e(route('homepage')); ?>" class="hover:text-white transition-colors">Trang chủ</a>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all group">
                        <div class="relative h-64 overflow-hidden">
                            <?php if($teacher->anh_dai_dien): ?>
                                <img src="<?php echo e(asset('storage/' . $teacher->anh_dai_dien)); ?>" alt="<?php echo e($teacher->ho_ten); ?>" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
                            <?php else: ?>
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <div class="absolute bottom-4 left-4 right-4 flex gap-2">
                                    <?php if($teacher->email): ?>
                                        <a href="mailto:<?php echo e($teacher->email); ?>" class="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-white/30 transition-colors">
                                            <span class="material-symbols-outlined text-lg">mail</span>
                                        </a>
                                    <?php endif; ?>
                                    <?php if($teacher->so_dien_thoai): ?>
                                        <a href="tel:<?php echo e($teacher->so_dien_thoai); ?>" class="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center text-white hover:bg-white/30 transition-colors">
                ...
                <?php if($teachers->hasPages()): ?>
                    <div class="flex justify-center">
                        <div class="flex items-center gap-2">
                            <?php echo e($teachers->links('pagination::tailwind')); ?>
        ...
        <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="text-center">
                    ...
                    <div class="text-3xl font-bold mb-2"><?php echo e($teachers->total()); ?></div>
                ...
                <div class="text-center">
                    ...
                    <div class="text-3xl font-bold mb-2"><?php echo e($teachers->pluck('mon_day')->filter()->unique()->count()); ?></div>
                ...
                <div class="text-center">
                    ...
                    <div class="text-3xl font-bold mb-2"><?php echo e($teachers->pluck('lop_chu_nhiem')->filter()->unique()->count()); ?></div>
                ...
                <div class="text-center">
                    ...
                    <div class="text-3xl font-bold mb-2"><?php echo e($teachers->where('nam_cong_tac', '<=', date('Y') - 10)->count()); ?></div>
    ...
    <footer class="bg-background-dark text-white pt-12 pb-8 border-t border-gray-800">
        <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
                ...
                <div>
                    ...
                    <ul class="flex flex-col gap-2 text-sm text-gray-400">
                        <li><a class="hover:text-primary transition-colors" href="<?php echo e(route('homepage')); ?>">Trang chủ</a></li>
                        <li><a class="hover:text-primary transition-colors" href="<?php echo e(route('homepage.news')); ?>">Tin tức</a></li>
                        <li><a class="hover:text-primary transition-colors" href="<?php echo e(route('homepage.teachers')); ?>">Giáo viên</a></li>
                        <li><a class="hover:text-primary transition-colors" href="<?php echo e(route('homepage.documents')); ?>">Tài liệu</a></li>
                    </ul>
                </div>
                <!-- Newsletter -->
                <div>
            ...
            <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p class="text-xs text-gray-500">© <?php echo e(date('Y')); ?> Trường THPT Chuyên.</p>
...
</html><?php /**PATH F:\Xampp\htdocs\laravel\Myto\resources\views/homepage/teachers.blade.php ENDPATH**/ ?>